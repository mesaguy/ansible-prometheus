...
describe file('/etc/prometheus/node_exporter_textfiles/promrun_root_basic.prom') do
  ...
  its('content') { should match /promrun_root_basic_starttime\{user="root"\} [0-9]+/ }
  ...
  its('content') { should match /promrun_root_basic_exit_status\{user="root"\} 0/ }
  ...
  its('content') { should match /promrun_root_basic_endtime\{user="root"\} [0-9]+/ }
...
describe command('sudo promrun -v -n root_basic echo -n 1') do
  ...
  its('stdout') { should match /promrun_root_basic_starttime\{user="root"\} [0-9]+/ }
  ...
  its('stdout') { should match /promrun_root_basic_exit_status\{user="root"\} 0/ }
  ...
  its('stdout') { should match /promrun_root_basic_endtime\{user="root"\} [0-9]+/ }
end
