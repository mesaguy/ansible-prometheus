...
describe command('sudo promrun -D -n root_dryrun ls /tmp > /dev/null') do
  ...
  its('stderr') { should match /\[DRYRUN\] promrun_root_dryrun_starttime\{user="root"\} [0-9]+/ }
  ...
  its('stderr') { should match /\[DRYRUN\] promrun_root_dryrun_exit_status\{user="root"\} 0/ }
  ...
  its('stderr') { should match /\[DRYRUN\] promrun_root_dryrun_endtime\{user="root"\} [0-9]+/ }
