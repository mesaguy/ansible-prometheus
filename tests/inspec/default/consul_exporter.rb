...
describe processes(Regexp.new("^/opt/prometheus/exporters/consul_exporter/(v)?([0-9.]+|[0-9.]+__go-[0-9.]+)/consul_exporter")) do
    it { should exist }
...
describe http('http://127.0.0.1:9107/metrics') do
    ...
    its('body') { should match /consul_exporter_build_info/ }
end
