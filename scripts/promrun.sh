...
function end_time_text () {
    printf "# HELP ${NAME}_endtime End time in Unix time with microseconds.
...
TIME_FORMAT="
# HELP ${NAME}_cpu_kernel_mode_seconds Total number of CPU-seconds that the process spent in kernel mode.
